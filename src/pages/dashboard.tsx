...
import { Package, IndianRupeeIcon, ShoppingCart, Plus } from "lucide-react";
...
export default function Dashboard() {
  ...
  const metrics = [
    ...
    },
    {
      ...
      icon: ShoppingCart,
      value: products?.filter((p) => p.quantity!= null && p.quantity < 10).length || 0,
    ...
    ? new Intl.NumberFormat("en-IN", {
        ...
        products.reduce(
          (sum, p) => sum + Number(p.purchasePrice) * Number(p.quantity),
          0
        )
      )
    : "0.00",
